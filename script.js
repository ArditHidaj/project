...
document.querySelector('#newsletter button').addEventListener('click', function() {
    var email = document.querySelector('#newsletter input[type="text"]').value;
    if (email.trim() === '') {
        alert('Please enter an email address.');
        return;
    }
    if (validateEmail(email)) {
        alert('Thank you for signing up for our newsletter! You will receive updates on prices and offers.');
    } else {
